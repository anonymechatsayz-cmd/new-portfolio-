...
const FeatureItem = ({ icon: Icon, text, className = "" }: { icon: any; text: string; className?: string }) => (
        ...
        >
          ...
          >
            <span className="relative flex h-1.5 w-1.5 md:h-2 md:w-2 shrink-0" aria-hidden="true">
              ...
              <span className="relative inline-flex rounded-full h-1.5 w-1.5 md:h-2 md:w-2 bg-emerald-500 shadow-[0_0_8px_2px_rgba(16,185,129,0.4)]"></span>
            </span>
            <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold text-anthracite/70 uppercase tracking-[0.1em] group-hover:text-anthracite/90 transition-colors duration-300 motion-reduce:transition-none whitespace-nowrap">Disponible pour nouveaux projets</span>
            <ArrowRight className="w-3 h-3 md:w-3.5 md:h-3.5 shrink-0 text-sand/60 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 group-hover:text-sand transition-all duration-300 motion-reduce:opacity-100 motion-reduce:translate-x-0" aria-hidden="true" />
          </motion.a>
